    ...
    languages: {
        ...
        ua: {
            Startup: {
                ...
                UserFound: 'Ваш акаунт було знайдено',
            },
            TextBox: {
                CoinStats: 'Можливі монети сьогодні: ',
                KlickStats: 'Сьогоднішні кліки: ',
            },
            WS:{
                Connected: 'Підключено до сервера',
                LostConError: 'Відключено від сервера',
                UnknownError: 'Невідома помилка підключенням до сервера',
                Reached_Day_limit: 'Ви досягли максимальної кількості монет за сьогодні',
            },
            Error: {
                400: 'Невідповідний запит',
